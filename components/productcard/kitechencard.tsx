...
import { DatakitchenAppliancesProducts } from "@/lib/data/kitchenapplicient";
import {
  FaAnglesRight,
  FaChevronLeft,
  FaChevronRight,
...
export default function KitechenCard() {
          ...
          <div className="relative group/slider">
            ...
            <div className="overflow-hidden cursor-grab active:cursor-grabbing" ref={emblaRef}>
              <div className="flex gap-4 md:gap-6">
                {DatakitchenAppliancesProducts.map((item) => {
